...
\caption{Political Donors in Wisconsin in 2016}
\end{figure}
...
since the statistical assumptions were not met for an OLS regression.
Results to \(H_{2}\) and \(H_{4}\) are in Table 2. Neither the
access-oriented donors nor the consumption-oriented donors contributed
statistically significantly different amounts of money than donors that
were donors that were not only access-oriented and not only
...
or consumptive behavior with the policy topics tested. The motivations
behind these clusters of donors remain unclear. It is possible that they
are motivated by ideological proximity in a way that is not adequately
tested using the methods in this paper. Future studies should test other
potential reasons that people make political contributions, such as
individuals contributing to ideologically proximate campaign,
geographically local campaigns, competitive campaigns, or other
...
\caption{\label{tab:unnamed-chunk-8}Social Media Examples}\\
\hline
...
\hline
Word count & 6888 & 6865\\
\hline
Character count & 46691 & 46680\\
\hline
Sentence count & 323 & Not available\\
\hline
Reading time & 34.4 minutes & 34.3 minutes\\
\hline
\end{tabular}
