...
plot <- granger_results %>% 
  mutate(topic = case_when(
    ...
    topic == "prolife" ~ "abortion and women's health: conservative",
    topic == "prochoice.womenshealth" ~ "abortion and women's health: liberal",
    topic == "other" ~ "other",
...
```{r}
ggsave("../tables_and_figures/aejmc_abstract_1.jpg", plot, height = 6.9, width = 7.3)
```
